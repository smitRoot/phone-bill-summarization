...
# genai.configure(api_key="AIzaSyAJw07d3Ccvs6ZM068ztaF4uqqP2Rsyrzc") # Replace with your actual API key
...
#         # Prepare the prompt and the image (if applicable, or just text)
#         prompt = """Based on the existing usage from the provided bill, 
